...
- [ ] **¿Integración SEPA?** - cruzar datos oficiales de preciosclaros.gob.ar para detectar diferencias entre precios declarados vs precios reales de cada supermercado 
