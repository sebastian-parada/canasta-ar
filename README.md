...
- [ ] **¿Integración SEPA?** - cruzar datos oficiales de preciosclaros.gob.ar para detectar diferencias entre precios declarados y precios reales de cada supermercado 
